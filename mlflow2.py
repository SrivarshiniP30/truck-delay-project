...
def main(alpha,l1_ratio):
    ...
    mlflow1.set_experiment("Truck delay")
    with mlflow1.start_run():
        
        mlflow1.log_param("alpha",alpha)
        mlflow1.log_param("l1_ratio",l1_ratio)
        ...
        mlflow1.log_metric("rmse",rmse)
        mlflow1.log_metric("mae",mae)
        mlflow1.log_metric("r2-score",r2)
        mlflow1.sklearn.log_model(model,"trained_model") # model, foldername
